    ...
    const _renderHeader = () => {
        return (
            <Block>
                ...
                <Text marginTop={4} size={20} lineHeight={30} fontWeight='400' color={colors.secondaryText} >
                    Welcome back you’ve
                    been missed
                </Text>
            </Block>
    ...
    const _renderForm = () => {
        return (
            <Block>
                ...
                <TextInput required secureTextEntry value={password} onChangeText={setPassword} />
            </Block>
        )
    }
    ...
    const _renderButtonDoLogin = () => {
        return (
            <Button onPress={() => { }}
                ...
                height={50}
                marginTop={28}
                titleProps={{ fontWeight: '600', size: 16, color: colors.white, marginTop: 2 }}
            />
        )
    }
